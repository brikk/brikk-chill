...
by **scanning the jar** with the existing generator (same treatment as kotlin-stdlib), never by
hand-listing.
...
- kotlinx runtime shipped inside the plugin zip; policy generated by scanner at plugin build
